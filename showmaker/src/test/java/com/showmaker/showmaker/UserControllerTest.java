...
public class UserControllerTest {
    ...
    public void postUser_whenUserHasNullUsername_receiveMessageOfNullErrorForUsername() {
        ...
        assertThat(validationErrors.get("username")).isEqualTo("유저의 이름은 널 값이면 안됩니다");
    }
    ...
    public void postUser_whenUserHasNullPassword_receiveGenericMessageOfNullError() {
        ...
        ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
        Map<String, String> validationErrors = response.getBody().getValidationErrors();
        assertThat(validationErrors.get("password")).isEqualTo("널 값이면 안됩니다");
    }
    ...
    public void postUser_whenAnotherUserHasSameUsername_receiveMessageOfDuplicateUsername() {
        ...
        ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
        Map<String, String> validationErrors = response.getBody().getValidationErrors();
        assertThat(validationErrors.get("username")).isEqualTo("이미 사용중인 이름입니다");
    }
    ...
    public void putUser_withValidRequestBodyWithTXTFromAuthorizedUser_receiveValidationErrorForProfileImage() throws IOException {
        ...
        assertThat(validationErrors.get("image")).isEqualTo("PNG, JPG 파일들만 허용됩니다");
    }
