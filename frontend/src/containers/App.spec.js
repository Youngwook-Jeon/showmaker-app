...
const setUserOneLoggedInStorage = () => {
    localStorage.setItem('showmaker-auth', JSON.stringify({
        id: 1,
        username: 'user1',
        displayName: 'display1',
        image: 'profile1.png',
...
describe('App', () => {
    ...
    it('saves logged in user data to localStorage after login success', async () => {
        ...
        const dataInStorage = JSON.parse(localStorage.getItem('showmaker-auth'));
    ...
    it('updates user page after clicking my profile when another non existing page was opened', async () => {
        apiCalls.getUser = jest.fn()
